    ...
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <GlassCard className="relative overflow-hidden border-blue-400 bg-blue-50/40">
          ...
          <p className="text-2xl font-bold text-slate-900 tracking-tight">{formatCurrency(bankAccount.currentBalance + pendingData.interest + pendingData.locked)}</p>
          <p className="text-[10px] font-medium text-blue-600 mt-2">Đã bao gồm lãi tạm tính & đã chi trả</p>
        </GlassCard>

...
import { Transaction, Project, User } from '../../../lib/models';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        ...
        if (payload.role !== 'Admin' && currentUser.organization) {
        ...
        if (projectId) {
            ...
            if (payload.role !== 'Admin' && project.organization !== currentUser.organization) {
